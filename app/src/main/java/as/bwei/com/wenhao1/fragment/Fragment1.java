...
import as.bwei.com.wenhao1.common.Api;
import as.bwei.com.wenhao1.utils.OkHttpUtils;
import as.bwei.com.wenhao1.adapter.ProductAdapter;
import as.bwei.com.wenhao1.bean.ProductBean;
import as.bwei.com.wenhao1.R;
import as.bwei.com.wenhao1.prseenter.RecyPresenter;
import as.bwei.com.wenhao1.utils.RequestCallback;
import okhttp3.Call;
...
public class Fragment1 extends Fragment implements XRecyclerView.LoadingListener,ProductAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        xrv = (XRecyclerView) view.findViewById(R.id.xrecycler_view);
        edit_txt = (EditText) view.findViewById(R.id.edit_txtC);
        btn_chaxun = (Button) view.findViewById(R.id.chaxun);
        return view;
    }
